 ...
 */
@HibernateDAO
public abstract class DAOTemplateHibernate<T extends DomainTemplate>
     ...
     *            object to be mapped
     * 
     * @return map of fields to their value
     * 
     * @throws Exception
        ...
        try {
            ...
            for (PropertyDescriptor propertyDescriptor : Introspector
                ...
                if (ann != null && (val != null || ann.nullable())
                        && ann.updatable()) {
                    result.put(ann.name().equals("")
                            ? propertyDescriptor.getName() : ann.name(), val);
                }
            }
